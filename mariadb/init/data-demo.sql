...
INSERT INTO parametro_sistema (identificador, nombre, valor)
  SELECT 'rango_validar_ubicacion', 'rango_validar_ubicacion', '10' WHERE NOT EXISTS (SELECT 1 FROM parametro_sistema WHERE identificador='rango_validar_ubicacion');
